...
import { aiDataState, cleanedImageState } from './state/appState';
...
export default function ImageUploader() {
  ...
  const [cleanedImage, setCleanedImage] = useRecoilState(cleanedImageState);
  const [aiData, setAiData] = useRecoilState(aiDataState);
  // const { setCleanedImageUrl, product, setProduct } = useProduct();
